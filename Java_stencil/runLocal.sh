...
$x86java -Djava.library.path="/Applications/CPLEX_Studio2211/opl/bin/x86-64_osx" -cp /Applications/CPLEX_Studio2211/cpoptimizer/lib/ILOG.CP.jar:src solver.cp.Main 